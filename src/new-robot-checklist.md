...
1. **Create code for all the subsystems the robot will have.** For the drive, use the code created by MechanicalAdvantage (designed specifically for AdvantageKit). In other words, use last year’s drive code and don’t change a thing unless absolutely needed.  
